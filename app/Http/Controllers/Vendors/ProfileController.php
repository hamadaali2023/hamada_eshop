...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $users=VendorBuyer::findOrFail($userid->id);
    ...
    public function updateProfile(Request $request)
    {
        ...
        $edit = VendorBuyer::findOrFail($userid->id);
    ...
    {        
        $userid = Auth::guard('vendorsbuyers')->user();
        $bankdetails=Bank::where('vendorId',$userid->id)->first();
        $country= Country::All();
        $cities= City::All();
        // dd($cities);
        $cities=City::all();
        ...
        return view('vendors.bank.edit',compact('bankdetails','country','cities','userid'));
    }
    public function updateBankDetails(Request $request)
    {
        $this->validate( $request,[          
         ...
         $userid = Auth::guard('vendorsbuyers')->user();
         $edit = Bank::where('vendorId',$userid->id)->first();
