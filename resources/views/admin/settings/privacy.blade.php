                    ...
                    <div class="card-body">
						<form action="{{url('admin/settings/privacy')}}" method="POST" name="le_form"  enctype="multipart/form-data">
			                @csrf
											...
											<div class="form-group">
												<label>سياسة الخصوصية سويدي</label>
												<!-- <input type="text" name="privacy" class="form-control" value="{{$contactInfo->privacy}}"> -->
												<textarea name="privacy_kr" id="des" id="ckeditor" cols="30" rows="15"  class="form-control ckeditor">{{$contactInfo->privacy_kr}}</textarea>
											</div>
