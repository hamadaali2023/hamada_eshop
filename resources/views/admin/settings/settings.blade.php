                  ...
                  <div class="card-body card-dashboard">
                   	<div class="card-body">
										<form action="{{url('admin/settings/update')}}" method="POST" 
											...
											<div class="form-group">
												<label>العنوان سويدي</label>
												<input type="text" name="title_kr" class="form-control" value="{{$contactInfo->title_kr}}">
											</div>
											...
											<div class="form-group">
												...
												<!-- <input type="text" name="privacy" class="form-control" value="{{$contactInfo->privacy}}"> -->
												<textarea name="description_kr" id="ckeditor" cols="30" rows="15"  class="form-control ckeditor" >{{$contactInfo->description_kr}}</textarea>
											</div>
											<!-- <div class="form-group">
												<label>الوصف انجليزي</label>
