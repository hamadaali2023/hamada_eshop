                    ...
                    <form action="{{route('sessions.store')}}" method="POST" 
			                                ...
			                                <div class="row form-row">
			                                    <div class="form-group col-12 col-sm-6">
			                                        <label>حدد الكورس</label>
			                                        <select name="liveId" class="form-control select2-diacritics required" placeholder="Select">
			                                            <option  disabled >Select</option>  
			                                            @foreach ($courses as $_item) 
			                                    	        <option value="{{$_item->id}}" {{ old('liveId') == $_item->id ? "selected" : "" }}>{{$_item->title}}</option>
			                                            @endforeach
			                                        </select>
			                                        @error('liveId')
