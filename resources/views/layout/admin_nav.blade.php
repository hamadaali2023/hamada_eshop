            ...
            <li class="dropdown dropdown-user nav-item">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <!--</form>-->
                 ...
                 <a class="dropdown-item" href="{{ route('signoutadmins') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> تسجيل الخروج </a>
                <form id="logout-form" action="{{ route('signoutadmins') }}" method="POST" class="d-none">
                  @csrf
                </form>
