                    ...
                    <div class="col-lg-5 offset-lg-1 col-md-6 widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <a href="{{url('about')}}" class="d-block mt-3">About Us</a>

                                <a href="{{url('contact')}}" class="d-block mt-3">Contact Us</a>
                            </div>

                            <div class="col-6">

                                <a href="{{url('terms/conditions')}}" class="d-block mt-3">Terms of Use</a>

                                <a href="{{url('policy')}}" class="d-block mt-3">Privacy Policy</a>
                            </div>
