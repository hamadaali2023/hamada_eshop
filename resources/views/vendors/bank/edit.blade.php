								...
								<div class="row form-row">	
									<div class="col-md-4 col-sm-6">
										<div class="form-group">
											...
											<input type="text" name="persone_name" class="form-control" value="{{$userid->name}}">
										</div>
									</div>	                	
									<div class="col-md-4 col-sm-6">
											<div class="form-group ">
												...
												@foreach ($country as $_item)
												   <option value="{{$_item->id}}" {{($_item->id==$bankdetails->countryId) ? 'selected' : '' }}>{{$_item->name_ar}}</option>
												@endforeach
											</select>
										</div>
									</div>
