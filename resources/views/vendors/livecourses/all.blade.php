...
@toastr_css
    ...
    <div class="content-header row">
                    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                      <h3 class="content-header-title mb-0 d-inline-block">الكوسات المباشره</h3><br>
                    ...
                    <div class="content-header-right col-md-6 col-12">
                      <div class="dropdown float-md-right">
                           <a href="{{route('straights.create')}}"  class="btn btn-primary float-right mt-2">أضافة كورس جديد</a>
                      </div>
                    </div>
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">االكورسات المباشرة</h4>
                    ...
                    <table class="table table-striped table-bordered keytable-integration">
                        ...
                        <tbody>                     
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="actions">
                                    <a href="{{route('straights.edit',$_item->id)}}" class="btn btn-sm bg-success-light" >
                                         تعديل
                                    </a>
