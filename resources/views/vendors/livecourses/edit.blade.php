                                ...
                                @method('put')
			                                <div class="row form-row">
			                                   <div class="form-group col-md-4 col-sm-6">
			                                        ...
			                                        <input type="text" name="title" class="form-control" value="{{$straight->title}}">
			                                        @error('title')
			                                    ...
			                                    <div class="form-group col-md-4 col-sm-6">
			                                        ...
			                                        <input type="text" name="detail" class="form-control" value="{{$straight->detail}}">
			                                        @error('detail')
			                                        	<span class="text-danger">{{$message}}</span>
			                                    	@enderror
			                                    </div>
			                                    ...
			                                    <div class="form-group col-12 col-sm-6">
			                                        ...
			                                        <input type="date" name="date" class="form-control" value="{{$straight->date}}">
			                                        @error('date')
			                                        	<span class="text-danger">{{$message}}</span>
			                                    	@enderror
			                                    </div>
			                                    ...
			                                    <div class="form-group col-12 col-sm-6">
			                                        ...
			                                        <input type="text" name="duration" class="form-control" value="{{$straight->duration}}">
			                                    	@error('duration')
			                                        	<span class="text-danger">{{$message}}</span>
			                                    	@enderror
			                                    </div>
			                                    ...
			                                    <div class="form-group col-12 col-sm-6">                                   
			                                     ...
			                                     <div class="form-group col-12 col-sm-6">
			                                        ...
			                                        <input type="text" name="price" class="form-control" {{ $straight->payed == '0' ? "disabled" : "" }} value="{{$straight->price}}" id="priceId">
