		...
		<div class="content-header row">
			        ...
			        <div class="content-header-right col-md-6 col-12">
			          <div class="dropdown float-md-right">
			               <a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-primary float-right mt-2">إضافة براند</a>
			          </div>
			        </div>
											...
											@foreach ($shops as $_item)
												<tr>													
													<td class="text-center">
														<img class="avatar-img" src="{{asset('img/shops/'.$_item->logo) }}" alt="Speciality" width="50" height="50">
													</td>
													<td class="text-center">
														{{$_item->name}}
													</td>
			...
			<div class="modal fade" id="edit" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
			 <form  method="post" action="{{route('shops.update','test')}}" enctype="multipart/form-data"
				>
                                @csrf
                                @method('put')
								<div class="row form-row">
